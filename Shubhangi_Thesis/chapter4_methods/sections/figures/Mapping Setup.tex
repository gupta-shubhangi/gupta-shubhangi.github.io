...
% \hfill
    \begin{subfigure}[b]{0.99\linewidth}
         \centering
         \includegraphics[width=0.99\linewidth]{chapter4_methods/sections/images/Mapping_setup.jpg}
...
\caption{
    Participatory Mapping setup: Projection of a map on a table on which participants can draw
}
