...
% \hfill
    \begin{subfigure}[b]{0.99\linewidth}
         \centering
         \includegraphics[width=0.99\linewidth]{chapter4_methods/sections/images/Mapspot_webpage.png}
...
\caption{
    Mapspot website displaying the red-lining maps data layer
}
\label{fig:mapspot_webpage}
\end{figure}
% \end{wrapfigure}
% \ref{fig:choleramap}